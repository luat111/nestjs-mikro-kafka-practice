...
export class Migration20221007035947 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "default_form_entity" ("id" uuid not null default uuid_generate_v4(), constraint "default_form_entity_pkey" primary key ("id"));');
